...
runtime {
    ...
    jpackage {
        ...
        installerOptions = listOf(
            ...
            "--linux-package-deps",
            "default-jre (>= 2:1.17) | openjdk-21-jre, libgomp1, libjpeg62-turbo | libjpeg-turbo8, liblcms2-2, liblensfun1, libraw19 | libraw20 | libraw23, libtiff5 | libtiff6, libxml2-utils", // .deb
