...
(cd "%_datadir/%name" && LD_LIBRARY_PATH="%_datadir/%name" exec java -Xmx256m -Djava.library.path="%_datadir/%name" -Dfile.encoding=utf-8 -classpath "%_datadir/%name/*" com.lightcrafts.platform.linux.LinuxLauncher ${@} )
EOF
