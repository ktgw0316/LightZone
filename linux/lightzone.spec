...
BuildRequires:	ant, autoconf, gcc, gcc-c++, make, tidy, git, javahelp2, libjpeg8-devel, libtiff-devel, liblcms2-devel
%if 0%{?fedora}
BuildRequires: java-1.7.0-openjdk-devel, libX11-devel
%define debug_package %{nil}
%endif
%if 0%{?sles_version}
BuildRequires: java-1_6_0-openjdk-devel, xorg-x11-libX11-devel, update-desktop-files
%endif
