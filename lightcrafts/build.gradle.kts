...
dependencies {
    ...
    implementation("org.eclipse.imagen:affine:0.9.2")
    implementation("org.eclipse.imagen:bandcombine:0.9.2")
    implementation("org.eclipse.imagen:bandmerge:0.9.2")
    implementation("org.eclipse.imagen:bandselect:0.9.2")
    implementation("org.eclipse.imagen:convolve:0.9.2")
    implementation("org.eclipse.imagen:crop:0.9.2")
    implementation("org.eclipse.imagen:format:0.9.2")
    implementation("org.eclipse.imagen:imagen-core:0.9.2")
    implementation("org.eclipse.imagen:rescale:0.9.2")
    implementation("org.ejml:ejml-simple:0.45.0")
}
application {
