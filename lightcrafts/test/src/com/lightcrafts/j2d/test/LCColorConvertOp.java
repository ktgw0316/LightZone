...
/*
 * @(#)LCColorConvertOp.java	1.37 03/01/23
 *
 ...
 */
public class LCColorConvertOp implements BufferedImageOp, RasterOp {
    ...
    /**
     * Constructs a new LCColorConvertOp which will convert
     ...
     */
    public LCColorConvertOp (RenderingHints hints)
    {
    ...
    /**
     * Constructs a new LCColorConvertOp from a ColorSpace object.
     ...
     */
    public LCColorConvertOp (ColorSpace cspace, RenderingHints hints)
    {
        if (cspace == null) {
    ...
    /**
     * Constructs a new LCColorConvertOp from two ColorSpace objects.
     * The RenderingHints argument may be null.
     ...
     */
    public LCColorConvertOp(ColorSpace srcCspace, ColorSpace dstCspace,
                            int renderingIntent,
                            RenderingHints hints)
    {
    ...
    public LCColorConvertOp(ColorSpace srcCspace, ColorSpace dstCspace,
                            RenderingHints hints)
    {
        this(srcCspace, dstCspace, -1, hints);
    }

     /**
     * Constructs a new LCColorConvertOp from an array of ICC_Profiles.
     * The RenderingHints argument may be null.
     ...
     */
    public LCColorConvertOp (ICC_Profile[] profiles, RenderingHints hints)
    {
        if (profiles == null) {
    ...
    /**
     * Returns the array of ICC_Profiles used to construct this LCColorConvertOp.
     * Returns null if the LCColorConvertOp was not constructed from such an
     * array.
     * @return the array of <code>ICC_Profile</code> objects of this
     *         <code>LCColorConvertOp</code>, or <code>null</code> if this
     *         <code>LCColorConvertOp</code> was not constructed with an
    ...
    private void updateBITransform(ICC_Profile srcProfile,
        ...
        if (theProfiles[0].getProfileClass() == ICC_Profile.CLASS_OUTPUT) {
            ...
            renderState = renderingIntent >= 0 ? renderingIntent : ICC_Profile.icRelativeColorimetric;
        }
        else {
            renderState = renderingIntent >= 0 ? renderingIntent : ICC_Profile.icPerceptual; /* render any other
                                                                                                class perceptually */
        }
     ...
     * create this LCColorConvertOp must have provided enough information
     ...
     *         <code>null</code> and this <code>LCColorConvertOp</code> was
     ...
     * @throws IllegalArgumentException if this <code>LCColorConvertOp</code>
